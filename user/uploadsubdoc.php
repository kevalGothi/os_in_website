                                    ...
                                    <div class="card-body">
                                        <form method="POST" enctype="multipart/form-data">
                                            <div class="form-group row">
                                                <label class="col-sm-2 col-form-label" style="color:#000;">Upload Document</label>
                                                <div class="col-sm-10">
...
<?php
    if(isset($_POST['submit'])){
       ...
       foreach($_FILES['listDraw']['name'] as $key => $val){
           ...
           $ssinsert = mysqli_query($conn, "INSERT INTO makeSubFolderDoc (row_id, sub_row_id, img, status) VALUES ('$rowID' , '$id' , '$val' , '0')");
       }
