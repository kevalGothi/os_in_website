                                    ...
                                    <div class="card-body">
                                        ...
                                        if(
                                            ...
                                            foreach($_FILES['img']['name'] as $key => $val){
                                                move_uploaded_file($_FILES['img']['tmp_name'][$key],$folder.$val);
                                                
                                                $ssinsert = mysqli_query($conn, "INSERT INTO new_doc (client_id, row_id, iimg, foldername, folderundar) VALUES ('$proid' , '$rowid' , '$val' , '$foldername' , '$folderNameUnder')");
                                            }
