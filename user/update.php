...
<?php
    require_once "../db/conn.php";
    $sql = mysqli_query($conn, "SELECT * FROM newProfile");
    foreach($sql as $data){
?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="profileEdit.php?id=<?php echo $data['id']; ?>" class="mr-2 " style="background:green; padding:7px; border-radius:5px; "><i class="fa fa-pencil button-default link" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit" style="color:#000;">Edit</i></a>
